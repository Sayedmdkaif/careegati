                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...options.map((option) => RadioListTile(
                              ...
                              title: Row(
                                children: [
                                  Text(HtmlUnescape().convert("$option"),style: MediaQuery.of(context).size.width > 800
                                  ? TextStyle(
                                    fontSize: 30.0
                                  ) : null,),

/*  SizedBox(width: 20,),
    Image.network('https://picsum.photos/250?image=9',width: 40,height: 40,)*/
                                ],
                              ),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          RaisedButton(
                            ...
                            child: Text("Previous", style: MediaQuery.of(context).size.width > 800
                                  ? TextStyle(fontSize: 30.0) : null,),
                            onPressed: _previousSubmit,
                          ), RaisedButton(
                            padding: MediaQuery.of(context).size.width > 800
                                  ? const EdgeInsets.symmetric(vertical: 20.0,horizontal: 64.0) : null,
                            child: Text(
